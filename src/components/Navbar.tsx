            ...
            <div className="relative group">
              ...
              {isProductsOpen && (
                <div className="absolute left-0 mt-2 w-56 rounded-xl shadow-2xl bg-[#1a153a] border border-white/10 py-2 z-50">
                  <a href="/#products" className="block px-5 py-2.5 text-sm text-gray-300 hover:text-white hover:bg-white/5 transition-colors">Raksham Web</a>
                  <a href="/#products" className="block px-5 py-2.5 text-sm text-gray-300 hover:text-white hover:bg-white/5 transition-colors">Staff App</a>
                  <a href="/#products" className="block px-5 py-2.5 text-sm text-gray-300 hover:text-white hover:bg-white/5 transition-colors">Guard App</a>
                </div>
              )}
            </div>
        ...
        <div className="md:hidden bg-[#100b29] border-t border-white/10 p-4 flex flex-col space-y-2 shadow-2xl h-screen">
          ...
          {isProductsOpen && (
            <div className="flex flex-col pl-8 space-y-2 pb-2">
              <a href="/#products" onClick={() => setIsOpen(false)} className="text-gray-400 hover:text-white py-2">Raksham Web</a>
              <a href="/#products" onClick={() => setIsOpen(false)} className="text-gray-400 hover:text-white py-2">Staff App</a>
              <a href="/#products" onClick={() => setIsOpen(false)} className="text-gray-400 hover:text-white py-2">Guard App</a>
            </div>
          )}
